...
export default class ManagementPlacesIndexController extends BaseController {
     ...
     * @var {Array}
     */
    queryParams = ['name', 'page', 'limit', 'sort', 'query', 'public_id', 'country', 'phone', 'created_at', 'updated_at', 'city', 'neighborhood', 'state','type'];
    ...
    @tracked columns = [
        // {
        //     label: this.intl.t('fleet-ops.common.place-type'),
        //     valuePath: 'type',
        ...
        // },
        {
            ...
            filterOptions: Object.keys(this.placeImages).map((key) => ({
                label: key,                       
    ...
    @action viewOnMap(place, options = {}) {
        ...
        const placeIcon = this.getIconForPlace(place.type);
    ...
    @action getIconForPlace(placeType) {
        const iconUrl = this.placeImages[placeType] || '/engines-dist/images/building-marker.png'; // Default icon if not found
        return iconUrl;
    }
